...
source("boot/software/functions/ld1.plot.ibts.r")
```
...
nep <- read.csv("boot/data/IBTS/evhoe.datras.nep.2024.csv")
...
# read shapefile
shapefile_path_FU <- "boot/data/shp/CelticSea_NepFUs.shp"
#shapefile_path_FU <- "C:/GitHub/2024_nep.fu.22_assessment/boot/data/shp/CelticSea_NepFUs.shp"
...
```{r dat1, eval=FALSE, fig.height=8, fig.width=8, warning=FALSE, include=FALSE}
...
#df <- read.table("boot/data/fu22SurveyLD_EVHOE.txt", sep="\t", header=T)
#df <- df[ , c(1:3, 5:7)]
...
plot.ld(df, "FU 19 EVHOE-WIBTS-Q4 [G9527]", 2003, 2024, 25, 35)
...
plot.ld(df, "FU 19 IGFS-WIBTS-Q4 [G7212]", 2003, 2024, 25, 35)
